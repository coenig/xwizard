 ...
 * @author Lukas König
 */
public class ArrayListVec2D extends ArrayList<Vector2D> {
     ...
     *            Der String-Vektor.
     */
    public ArrayListVec2D(final List<Vector2D> liste) {
        if (liste != null) {
            for (Vector2D s : liste) {
                this.add(s);
            }
        }
    }
     ...
     *            Der String-Vektor.
     */
    public ArrayListVec2D(final Vector2D[] array) {
        if (array != null) {
            for (Vector2D s : array) {
                this.add(s);
            }
        }
    }
     ...
     */
    public ArrayListVec2D(final int size) {
        super(size);
    }
