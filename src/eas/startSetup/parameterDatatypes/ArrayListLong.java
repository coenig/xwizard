 ...
 * @author Lukas König
 */
public class ArrayListLong extends ArrayList<Long> {
     ...
     *            Der String-Vektor.
     */
    public ArrayListLong(final List<Long> liste) {
        if (liste != null) {
            for (Long s : liste) {
                this.add(s);
            }
     ...
     *            Der String-Vektor.
     */
    public ArrayListLong(final long[] array) {
        if (array != null) {
            for (Long s : array) {
                this.add(s);
            }
     ...
     */
    public ArrayListLong(final int size) {
        super(size);
    }
