...
public class ArrayListString extends ArrayList<String> {
     ...
     * 
     * @param array  Der String-Vektor.
     */
    public ArrayListString(final Collection<String> liste) {
        if (liste != null) {
            for (String s : liste) {
                this.add(s);
            }
     ...
     * @param array  Der String-Vektor.
     */
    public ArrayListString(final String[] array) {
        if (array != null) {
            for (String s : array) {
                this.add(s);
            }
     ...
     * Konstruktor.
     * 
     * @param size  Die erwartete Größe der Liste.
     */
    public ArrayListString(final int size) {
        super(size);
    }
