...
public class ArrayListDouble extends ArrayList<Double> {
     ...
     *            Der String-Vektor.
     */
    public ArrayListDouble(final List<Double> liste) {
        if (liste != null) {
            for (Double s : liste) {
                this.add(s);
            }
     ...
     *            Der String-Vektor.
     */
    public ArrayListDouble(final double[] array) {
        if (array != null) {
            for (Double s : array) {
                this.add(s);
            }
     ...
     */
    public ArrayListDouble(final int size) {
        super(size);
    }
    ...
    public static ArrayListDouble parseArrayListDouble(String list) {
        String[] strArr = list.replace(" ", "").split(",");
        ArrayListDouble doubListe = new ArrayListDouble(strArr.length);
        for (String s : strArr) {
