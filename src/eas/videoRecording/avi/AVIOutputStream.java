 ...
 */
package eas.videoRecording.avi;
 ...
 */
public class AVIOutputStream implements Serializable {

    private static final long serialVersionUID = -6427608157708159254L;

    /**
     * Output stream of the AVIOutputStream.
     */
    private transient ImageOutputStream out;
    ...
    private static class Sample implements Serializable {
        ...
        private static final long serialVersionUID = -8063754309211264285L;
         ...
         * @param length
         */
        public Sample(@SuppressWarnings("unused") int duration, long offset, long length) {
            this.offset = offset;
            this.length = length;
        }
    }
     ...
     * Chunk base class.
     */
    private abstract class Chunk implements Serializable {

        /**
         * 
         */
        private static final long serialVersionUID = -8697126128699629095L;
        /**
    ...
    private class CompositeChunk extends Chunk {
         ...
         * 
         */
        private static final long serialVersionUID = 6623411079992847157L;
        /**
    ...
    private class DataChunk extends Chunk {
         ...
         * 
         */
        private static final long serialVersionUID = -8573783505379894670L;
    ...
    private class FixedSizeDataChunk extends Chunk {
         ...
         * 
         */
        private static final long serialVersionUID = -1330483998072703853L;
        private DataChunkOutputStream data;
        private boolean finished;
    ...
    private void writeEpilog() throws IOException {
        for (@SuppressWarnings("unused") Sample s : videoFrames) {
        }
        long bufferSize = 0;
