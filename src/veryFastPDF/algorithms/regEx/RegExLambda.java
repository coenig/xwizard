/*
 * File name:        RegExpLambda.java (package eas.miscellaneous.graphToPDF)
 * Author(s):        lko
 * Java version:     7.0
 * Generation date:  11.05.2013 (09:50:57)
 *
 ...
 * @author lko
 */
public class RegExLambda extends AbstractRegEx {

    @Override
    public String toString(boolean latex) {
        if (latex) {
            return "\\emptyset^\\star";
        } else {
            return "O*";
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return RegExLambda.class.equals(obj.getClass());
    }

    @Override
    public AbstractRegEx copy() {
        return new RegExLambda();
    }
